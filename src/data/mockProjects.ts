...
export const MOCK_PROJECTS: ProjectData[] = [
  {
    title: "Aura Neural Analytics Platform",
    slug: "aura-neural-analytics",
    category: "Full Stack / AI Infrastructure",
    year: 2024,
    ...
    techStack: ["Next.js 14", "TypeScript", "Tailwind CSS", "MongoDB", "Python FastAPI", "WebSockets"],
    liveUrl: "https://example.com/aura",
    githubUrl: "https://github.com/example/aura-analytics",
    problem: "Enterprise engineering teams were overwhelmed by raw telemetry streams without actionable real-time insights or custom machine learning anomaly detection pipelines.",
    solution: "Engineered a low-latency analytics suite using Next.js App Router for frontend stream rendering and FastAPI/MongoDB for high-throughput metric persistence and vector index queries.",
    result: "Reduced telemetry ingest processing latency by 64% while enabling sub-second multi-dimensional querying for over 50,000 active concurrent data streams.",
    featured: true,
    order: 1,
  },
  {
